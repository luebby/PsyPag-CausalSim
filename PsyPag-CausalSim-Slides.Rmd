...
- I will use [https://tweedback.de/?l=en](https://tweedback.de/?l=en) for anonymous realtime feedback. Our Session-ID is **xxxx**.
...
`r fontawesome("hand-point-right", style = "solid")` Causality and directed acyclic graphs together with data simulations may provide a framework to think about the data generating process and the consequences thereof for choosing an estimator for your estimand (and to understand what is going on in Simpson’s or Berkson’s paradox).
...
Crash course for variable selection:

- [Cinelli, C., Forney, A., & Pearl, J. (2020). A Crash Course in Good and Bad Controls. Available at SSRN 3689437.](https://dx.doi.org/10.2139/ssrn.3689437)
